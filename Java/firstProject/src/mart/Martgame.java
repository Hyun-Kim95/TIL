...
//	}
//
//	public Appliances sellItem(int num, String companyname, Buyer guest) {
//		Appliances Item;
//		switch (num) {
//		case 1:
...
//	}
//
//	private Appliances searchComputer(String companyname, Buyer guest) {
//		Appliances Item;
...
//	}
//
//	private Appliances searchAirconditioner(String companyname, Buyer guest) {
//		Appliances Item;
...
//	}
//
//	private Appliances searchRefrigerator(String companyname, Buyer guest) {
//		Appliances Item;
...
//	}
//
//	private Appliances searchAircleaner(String companyname, Buyer guest) {
//		Appliances Item;
//
...
//				b[i].showMoney();
//			}
//			if ((b[0].getMoney() < Mart.a) && (b[1].getMoney() < Mart.a) && (b[2].getMoney() < Mart.a))
//				break;
//		}
//		
