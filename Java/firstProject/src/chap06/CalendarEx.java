...
public class CalendarEx {
	...
	public static void main(String[] args) {
		...
		Calendar now2 = now;
		System.out.println("now calendar : "+Integer.toHexString(now.hashCode()));
		System.out.println("now2 calendar : "+Integer.toHexString(now2.hashCode()));
		System.out.println("firstDate calendar : "+Integer.toHexString(firstDate.hashCode()));
