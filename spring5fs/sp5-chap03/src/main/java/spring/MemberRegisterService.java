...
public class MemberRegisterService {
	...
	public void regist(RegisterRequest req)
	{
		...
		// 그 값은 memberDao에 selectByEmail함수를 호출하고 req변수의 getEmail함수에서 리턴되는 값을 넘겨준다.
