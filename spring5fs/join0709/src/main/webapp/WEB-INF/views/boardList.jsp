    ...
    <head>
        ...
        <script type="text/javascript">
            $(document).ready(function(){
            	...
            	//List 페이지버튼 생성 => 데이터베이스에 게시판 테이블의 갯수를 알아야 페이지버튼을 만든다.
            	//웹페이지가 만들어지기 전에 준비단계에서 설정을 해야함
                ...
                //전체 페이지 수를 받아 돌린다.
                // 태그의 내용을 상황에 따라 변경하는 방법
                // 1. 태그를 문자열로 만들고 var 변수에 대입
                // 2. class, id를 이용해서 위치 선택
                // 3. ().append(만든 var 변수)를 넣고 실행
                // 4. 상황에 맞는 HTML, CSS가 추가 됨
                ...
                $(document).on("click","button[name='page_move']",function(){
                    ...
                    // 값을 Java로 내릴 때 name, Modelattribute 사용함
                    // javaScript에서 각각의 id, class로 값을 찾아와서
                    // 그 값을 Java로 내려줌
